<?php
    ...
    if ($text == "") {
        ...
        // $ response = "CON Bienvenue dans les cours en ligne à HLAB \ n" ;
        // $ response. = "1. Enregistrer \ n" ;
    ...
    elseif ($text == "1") {
        ...
        // $ response = "CON Choisissez le framework à apprendre \ n" ;
        // $ response. = "1. Django Web Framework \ n" ;
